...
<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image1.png" alt="Tạo VPC" style="max-width:100%;height:auto;" />
  <figcaption><em>Tạo VPC riêng cho dự án</em></figcaption>
</figure>

<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image5.png" alt="Security group ALB" style="max-width:100%;height:auto;" />
  <figcaption><em>Security group cho Application Load Balancer</em></figcaption>
</figure>

<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image9.png" alt="Cấu hình RDS" style="max-width:100%;height:auto;" />
  <figcaption><em>Các bước tạo cơ sở dữ liệu RDS</em></figcaption>
</figure>

<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image15_new.png" alt="Cấu hình kết nối" style="max-width:100%;height:auto;" />
...
6. **Templates**: Chọn **Sandbox** (Cấu hình tài nguyên ở mức tối thiểu để tối ưu chi phí sử dụng).
...
1. **DB instance class**: Chọn `db.t3.small` (Hoặc lớp cấu hình thấp nhất có sẵn tương đương).
...
3. **Public access**: Chọn **Yes** (Bắt buộc chọn **Yes** để cơ sở dữ liệu có địa chỉ IP công cộng giúp máy tính cá nhân của bạn kết nối được thông qua SSMS phục vụ mục đích kiểm tra/lập trình).
...
<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image20.png" alt="Mở SSH tunnel" style="max-width:100%;height:auto;" />
  <figcaption><em>Mở SSH tunnel từ Command Prompt</em></figcaption>
</figure>

<figure>
  <img src="https://khanduyn.github.io/AWS-FCAJ-2026/images/5-Workshop/5.2-VPC-RDS/image21.png" alt="Kết nối SSMS" style="max-width:100%;height:auto;" />
